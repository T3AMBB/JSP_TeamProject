                        ...
                        <div class="col-md-9 col-sm-12 col-xs-12">
                           <div id="Container">
                              ...
                              <div id="Contents">
                                 <div class="sub_title_area customer" >
                                    <h1 style="margin-bottom:7%;">커뮤니티</h1>
                                 </div>                               
                                 <!-- 게시글 콘텐츠 시작 -->
                                                   ...
                                                   <tr class="notice_fix">
                                                      ...
                                                      <c:choose>
                                                         <c:when test="${b.role eq 'admin'}">
                                                            ...
                                                            </strong><a href="communityBoard.do?bid=${b.bid}"> <b>&lt공지&gt</b>${b.btitle}
                                                            </a></td>
                                                         </c:when>
                                                         <c:when test="${b.role eq 'MVP'}">
                                                            <td class="subject"><strong class="FG01">
                                                            </strong><a href="communityBoard.do?bid=${b.bid}"
                                                               style="color: skyblue;"> <b>&lt★MVP★&gt</b>${b.btitle}
                                                            </a></td>
                                                         </c:when>
                                                         <c:otherwise>
                                                            <td class="subject"><strong class="FG01">
                           ...
                           <c:if test="${member != null}">
                              <div class=list_bottom_btnbox>
                                 <div style="float: right;">
                                    <a href="communityForm.jsp"><button style="color:black; background-color:gold; border:1px solid gold; border-radius:1rem; width:100px; padding:3px;">글 작성하기</button></a>
                                 </div>
                              </div>
                           </c:if>
                           ...
                           <ul class="pagination">
                              ...
                              <c:forEach var="c" items="${datas_size}" varStatus="status"
                                 ...
                                 <a
                                    href="community.do?cnt=${status.count+pcnt+(4*(status.count+pcnt-1))}">${status.count+pcnt}&nbsp;</a>
                                 &nbsp;&nbsp;
                              </c:forEach>

                              <c:if test="${datas_size.size()>end}">
                                 <li class="icon-next"><a
                                    href="community.do?cnt=${end+2}"><i
