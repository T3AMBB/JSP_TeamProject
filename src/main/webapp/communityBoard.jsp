               ...
               <div class="col-md-9 col-sm-12 col-xs-12">
                  <div class="blog-detail-ct">
                     <div class="btitle" style="margin-bottom: 1%;">
                           ...
                           <c:choose>
                              <c:when test="${lvo.report=='1'}">
                                 <img id="photo3" onclick="report();" alt="신고 활성화"
                                    ...
                                    style="width: 40px; height: 40px; margin: 0px; cursor:pointer;">
                              </c:when>
                              <c:otherwise>
                                 <img id="photo3" onclick="report();" alt="신고 비활성화"
                                    src="images/alert2.png"
                                    style="width: 40px; height: 40px; margin: auto; cursor:pointer;">
                              </c:otherwise>
                           </c:choose>
                            <input id="result3" type="hidden" value="${b.cnt_r}"
                        ...
                        <p style="float: right; margin:revert;">추천, 비추천, 신고 기능은 로그인 후 이용해주세요</p>
                        </c:if>
                        <div>
                           <br> <br>
                     ...
                     <c:if test="${member != null}">
                           ...
                           <div style="display: inline-block;">
                            ...
                            <div style="display: inline-block;"> <!-- 비추천 -->
                              <c:choose>
