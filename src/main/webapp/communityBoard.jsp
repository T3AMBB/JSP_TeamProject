                  ...
                  <div class="blog-detail-ct">
                     <div class="btitle" style="margin-bottom:1%;">
                       ...
                       <hr>
                        ...
                        <div style= "float: right; margin-top:-6.2%;">
                        <c:choose>
                           <c:when test="${lvo.lstatus=='1'}">
                              <img id="photo1" onclick="lstatus();" alt="추천 활성화" src="images/thumbsUp1.png" width="30px" height="30px">
                           </c:when>
                           <c:otherwise>
                              <img id="photo1" onclick="lstatus();" alt="추천 비활성화" src="images/thumbsUp2.png" width="30px" height="30px">
                           </c:otherwise>
                        </c:choose>
                        <span id="result1" type="text" value="${b.cnt_l}" width="30px" height="30px"></span>
                     </div>
                     
                     <div style= "display=inline-block; float: right; margin-top:-6.2%;">
                        <c:choose>
                           <c:when test="${lvo.nlstatus=='1'}">
                              <img id="photo2" onclick="nlstatus();" alt="비추천 활성화" src="images/thumbsDown1.png" width="30px" height="30px">
                           </c:when>
                           <c:otherwise>
                              <img id="photo2" onclick="nlstatus();" alt="비추천 비활성화" src="images/thumbsDown2.png" width="30px" height="30px">
                           </c:otherwise>
                        </c:choose>
                        <span id="result2" type="text" value="${b.cnt_n}" width="30px" height="30px"></span>
                     </div>
                     
                     <div style= "display=inline-block; float: right; margin-top:-6.2%; ">
                        <c:choose>
                           <c:when test="${lvo.report=='1'}">
                        <img id="photo3" onclick="report();" alt="신고 활성화" src="images/alert1.png" width="30px" height="30px">
                           </c:when>
                           <c:otherwise>
                        <img id="photo3" onclick="report();" alt="신고 비활성화" src="images/alert2.png" width="30px" height="30px">
                           </c:otherwise>
                        </c:choose>
                        <span id="result3" type="text" value="${b.cnt_r}" width="30px" height="30px"></span>
                     </div>
                     </div>
                     </div>
                     </div>
                        <!-- <div class="cncjs" style="display: inline-block; float: right; width: 30%;">
