...
SELECT * FROM (SELECT A.*, ROWNUM AS RNUM FROM(SELECT * FROM REPLY_RE LEFT OUTER JOIN REPLY ON REPLY_RE.RID=REPLY.RID WHERE REPLY_RE.RID=3010 ORDER BY REPLY_RE.RRID DESC) A WHERE ROWNUM < = 1+4)WHERE RNUM  > = 1
...
INSERT INTO BOARD VALUES((SELECT NVL(MAX(BID),1000)+1 FROM BOARD),'111','111','111','admin','111');
INSERT INTO BOARD VALUES((SELECT NVL(MAX(BID),1000)+1 FROM BOARD),'111','111','111','admin','111');
INSERT INTO BOARD VALUES((SELECT NVL(MAX(BID),1000)+1 FROM BOARD),'111','111','111','admin','111');
INSERT INTO BOARD VALUES((SELECT NVL(MAX(BID),1000)+1 FROM BOARD),'111','111','111','admin','111');
INSERT INTO BOARD VALUES((SELECT NVL(MAX(BID),1000)+1 FROM BOARD),'111','111','111','admin','111');
...
DELETE FROM BOARD WHERE BID=1027;
